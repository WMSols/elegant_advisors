...
/// Detail dialog showing full inquiry information
class AdminInquiryDetailDialog extends StatelessWidget {
  final ContactSubmissionModel inquiry;
  final VoidCallback onReply;
  final VoidCallback onDelete;
  final VoidCallback? onViewProperty;

  const AdminInquiryDetailDialog({
    super.key,
