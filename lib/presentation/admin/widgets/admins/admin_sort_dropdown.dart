...
/// Reusable sort dropdown widget for admin management
class AdminSortDropdown extends StatelessWidget {
  ...
  String _getDisplayText(String option) {
    switch (option) {
      case 'name':
        return AppTexts.adminManageAdminsSortByName;
      case 'email':
        return AppTexts.adminManageAdminsSortByEmail;
      case 'createdAt':
        return AppTexts.adminManageAdminsSortByCreatedDate;
      default:
        return option;
    }
  }
