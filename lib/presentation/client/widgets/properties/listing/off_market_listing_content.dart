...
/// Responsive listing content widget for Off Market
class OffMarketListingContent extends StatelessWidget {
  final ClientOffMarketController controller;

  const OffMarketListingContent({super.key, required this.controller});
    ...
    return Obx(() {
      ...
      if (errorMsg.isNotEmpty) {
        return AppErrorState(
          title: context.l10n.clientOffMarketErrorLoading,
          message: errorMsg,
          onRetry: controller.loadProperties,
          retryButtonText: context.l10n.clientOffMarketRetry,
        );
      }

      if (displayedCount == 0) {
        return AppEmptyState(
          title: context.l10n.clientOffMarketNoPropertiesFound,
          message: context.l10n.clientOffMarketNoPropertiesMessage,
          buttonText: controller.filters.value.hasActiveFilters
              ? context.l10n.clientOffMarketClearFilters
              : null,
