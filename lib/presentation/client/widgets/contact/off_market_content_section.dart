...
import 'package:elegant_advisors/presentation/client/widgets/contact/off_market_form_section.dart';
import 'package:elegant_advisors/presentation/client/widgets/contact/contact_office_details_section.dart';

/// Off Market content section with background (same design as contact: form + office details)
class OffMarketContentSection extends StatelessWidget {
  const OffMarketContentSection({super.key});
            ...
            builder: (context, constraints) {
              if (constraints.maxWidth >= 768) {
                return Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Expanded(flex: 1, child: const OffMarketFormSection()),
