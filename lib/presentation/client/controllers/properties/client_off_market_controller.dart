...
class ClientOffMarketController extends BaseController {
  ...
  GlobalKey get listingSectionKey {
    ...
    _listingSectionKey ??= GlobalKey(
      debugLabel: 'off_market_listing_${_keyCounter}_$_instanceId',
    );
  ...
  Future<void> loadProperties() async {
    ...
    try {
      // Use stream for real-time updates - get only off-market properties
      _propertiesSubscription = _firestoreService
          ...
          .listen(
            ...
            onError: (error) {
              ...
              final errorText =
                  l10n?.clientOffMarketErrorLoading ??
  ...
  void applyFilters() {
    ...
    // Note: Status filter is not applied here since all properties are already off-market
